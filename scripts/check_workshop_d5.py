...
if release in {'R110C_BRAND_LOGO','R111A_NOSCRIPT_FORM_FALLBACK','R111B_BRAND_MARK_FAVICON','R111C_RU_TITLE_LOCALIZATION','R111D_SITEMAP_LASTMOD','R112_PLATFORM_SHORTCUT_TITLES','R114_BRAND_TOUCH_TARGET'}:protected.update(R110C_PROTECTED_OVERRIDES)
if release in {'R111B_BRAND_MARK_FAVICON','R111C_RU_TITLE_LOCALIZATION','R111D_SITEMAP_LASTMOD','R112_PLATFORM_SHORTCUT_TITLES','R114_BRAND_TOUCH_TARGET'}:protected.update(R111B_PROTECTED_OVERRIDES)
if release in {'R111D_SITEMAP_LASTMOD','R112_PLATFORM_SHORTCUT_TITLES','R114_BRAND_TOUCH_TARGET'}:protected.update(R111D_PROTECTED_OVERRIDES)
if release in {'R112_PLATFORM_SHORTCUT_TITLES','R114_BRAND_TOUCH_TARGET'}:protected.update(R112_PROTECTED_OVERRIDES)
...
if release in {'R111C_RU_TITLE_LOCALIZATION','R111D_SITEMAP_LASTMOD','R112_PLATFORM_SHORTCUT_TITLES','R114_BRAND_TOUCH_TARGET'}: legal.update(R111C_LEGAL_OVERRIDES)
if release in {'R112_PLATFORM_SHORTCUT_TITLES','R114_BRAND_TOUCH_TARGET'}: legal.update(R112_LEGAL_OVERRIDES)
