...
redirects=obj.get('redirects',[]); expected_redirects=[{'source':'/:path*','has':[{'type':'header','key':'host','value':'ai-skill-lab.vercel.app'}],'destination':'https://aiskillab.work/:path*','permanent':True}]
