...
export function BriefCompiler({locale="ru"}:{locale?:Locale}){
  ...
  const labels=locale==="ru"?{goal:"01 · GOAL",context:"02 · CONTEXT",output:"03 · OUTPUT",verify:"04 · VERIFY",copy:"Скопировать brief",copied:"Скопировано",failed:"Не удалось скопировать",local:"Локальный compiler · ничего не отправляется"}:{goal:"01 · GOAL",context:"02 · CONTEXT",output:"03 · OUTPUT",verify:"04 · VERIFY",copy:"Copy brief",copied:"Copied",failed:"Copy failed",local:"Local compiler · nothing is sent"};
