    ...
    <div className={styles.pageRoot} data-paper="1">
            ...
            <div className={styles.proofRight}>
              <div className={styles.proofBoard} aria-label={isRu ? "Гейты релизной системы" : "Release system gates"}>
                <div className={styles.proofBoardHeader}>
                  <span className={styles.proofBoardTitle}>AI SKILL LAB / R73 LIVE VERIFIED EVIDENCE</span>
                  <span className={styles.proofBoardBadge}>● R73 LIVE VERIFIED</span>
                </div>
              ...
              <div className={styles.defectCard}>
                ...
                <p className={styles.defectText}>
                  {isRu
                    ? "R73 LIVE VERIFIED. R73 был promoted одной SHA-bound попыткой из exact qualified preview. Vercel создал новый production deployment, а platform metadata связывает его с exact qualified preview; production затем независимо проверен по exact R73 manifest и required 6/6 live route smoke."
                    : "R73 LIVE VERIFIED. R73 was promoted in one SHA-bound attempt from the exact qualified preview. Vercel created a new production deployment, and platform metadata binds it to that exact qualified preview; production was then independently verified against the exact R73 manifest and the required 6/6 live route smoke."}
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className={styles.footer} data-dark="1">
        ...
        <div className={styles.footerBottom}>
          ...
          <span>R73 LIVE VERIFIED · EXACT QUALIFIED PREVIEW BOUND</span>
        </div>
      </footer>
    </div>
  );
