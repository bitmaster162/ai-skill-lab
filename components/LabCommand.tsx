...
const copy = {
  ...
  en: {
    ...
    items: [
      ...
      ["02", "AI Studio", "/en/studio", "BUILD WITH US"],
      ["03", "Project Studio", "/en/projects", "ARTIFACTS"],
      ["04", "Pilot Simulator", "/en/business#pilot-simulator", "BUSINESS"],
      ["05", "Program Matcher", "/en/matcher", "MATCH"],
      ["06", "AI Challenge", "/en/challenge", "SYSTEM"],
      ["07", "Build Log", "/en/build", "PROVENANCE"],
      ["08", "Start", "/en/start", "START"],
    ],
  },
} as const;
