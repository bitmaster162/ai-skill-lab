...
export default function SafetyPage() {
  return <LegalPage path="safety" title="Безопасность детей и AI" intro="Правила программы для 8–18 лет: взрослый остаётся в контуре, персональные данные минимизируются, а ответы моделей проверяются.">
    ...
    <p data-policy-verified="2026-09-26"><a className="inlineExternal" href="https://help.openai.com/en/articles/8313401" target="_blank" rel="noreferrer">Официальная справка OpenAI ↗</a> · проверено 26 сентября 2026</p>
