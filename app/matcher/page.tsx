...
export const metadata: Metadata = {
  title: { absolute: "Подобрать AI-программу — AI Skill Lab" },
  ...
  twitter: { card: "summary_large_image", title: "Подобрать AI-программу", description: "Локальный program matcher: взрослый, ребёнок, подросток или business pilot. Ничего не отправляется и не сохраняется.", images: ["/og.png"] },
};
