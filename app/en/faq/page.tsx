...
export default function FaqPage() {
  return <><Header locale="en" contactHref="/en/start" alternateHref="/faq"/><main id="main"><section className="hero heroR2"><div className="shell"><div className="eyebrow"><span className="dot"/> FAQ · BEFORE YOU START</div><h1>Questions first.<br/><span>Package second.</span></h1><p className="heroLead">Short answers to the things worth understanding before the first conversation.</p><div className="heroActions"><Link className="button buttonPrimary" href="/en/start">Discuss the goal →</Link><Link className="textLink" href="/en/pricing">Pricing →</Link></div></div></section><section className="section"><div className="shell"><div className="faqGrid"><div className="sectionHead stickyHead"><span className="kicker">FAQ</span><h2>8 short answers</h2></div><div className="faqList">{items.map(([q,a])=><details key={q}><summary>{q}<span>+</span></summary><p>{a}</p></details>)}</div></div></div></section></main><Footer locale="en"/></>;
}
