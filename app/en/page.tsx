        ...
        <section className="hero heroR2">
          ...
          <div className="shell heroGrid">
            <div className="heroCopy">
              ...
              <div className="heroActions"><Link className="button buttonPrimary" href="/en/proof">Launch Proof Lab <ArrowIcon /></Link><Link className="textLink heroLabTrigger" href="/en/start">Find my program <ArrowIcon /></Link></div>
