...
export const metadata: Metadata = { title: "Terms of service", description: "Terms for AI Skill Lab educational programs: website application, payment and conditions before training starts." };
