...
export const metadata: Metadata = { title: { absolute: "Youth AI Safety — AI Skill Lab" }, description: "Age rules, privacy and adult involvement for AI Skill Lab youth programs." };
