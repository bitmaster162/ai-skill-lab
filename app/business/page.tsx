...
export default function Page() {
  return <>
    ...
    <main id="main">
      ...
      <section className="section" id="capacity-scenario"><div className="shell"><div className="sectionHead"><span className="kicker">Business economics · scenario</span><h2>Посчитать потенциал,<br/>не выдавая сценарий за прогноз.</h2><p className="sectionSub">Задайте размер команды, объём рутины, стоимость часа и собственное допущение о доле времени, которую реально можно высвободить. Калькулятор считает только чувствительность по этим входам и не обещает экономию.</p></div><BusinessValueCalculator/></div></section>
