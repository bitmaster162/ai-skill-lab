...
const items = [
  ...
  ["Сколько длится одно занятие?", "Одна сессия длится 60 минут. Количество занятий указано в пакете; расписание и остальные условия фиксируются до оплаты как часть конкретного scope."],
];
