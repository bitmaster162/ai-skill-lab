...
export const metadata: Metadata = { title: "Privacy policy and data handling", description: "AI Skill Lab privacy policy for the public application form and direct contact routes.", alternates: { canonical: "/en/privacy", languages: { ru: "/privacy", en: "/en/privacy" } } };
